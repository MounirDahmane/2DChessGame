...
public:
    ...
    struct MouseWheelScrollEvent
    {
        ...
        float delta; //!< Wheel offset (positive is up/left, negative is down/right). High-precision
                     //!< mice may use non-integral offsets.
        int x;       //!< X position of the mouse pointer, relative to the left of the owner window
        int y;       //!< Y position of the mouse pointer, relative to the top of the owner window
    };
    ...
    {
        unsigned int joystickId; //!< Index of the joystick (in range [0 .. Joystick::Count - 1])
        unsigned int button;     //!< Index of the button that has been pressed (in range [0 ..
                                 //!< Joystick::ButtonCount - 1])
    };
    ...
    union
    {
        ...
        MouseWheelEvent
            mouseWheel; //!< Mouse wheel event parameters (Event::MouseWheelMoved) (deprecated)
        MouseWheelScrollEvent
            mouseWheelScroll; //!< Mouse wheel event parameters (Event::MouseWheelScrolled)
        JoystickMoveEvent joystickMove; //!< Joystick move event parameters (Event::JoystickMoved)
        JoystickButtonEvent
            joystickButton; //!< Joystick button event parameters (Event::JoystickButtonPressed,
                            //!< Event::JoystickButtonReleased)
        JoystickConnectEvent
            joystickConnect; //!< Joystick (dis)connect event parameters (Event::JoystickConnected,
                             //!< Event::JoystickDisconnected)
        TouchEvent touch;    //!< Touch events parameters (Event::TouchBegan, Event::TouchMoved,
                             //!< Event::TouchEnded)
