...
public:
    ...
    /// OR combination of sf::Style enumerators \param settings Additional settings for the
    ...
    /// \param mode     Video mode to use (defines the width, height and depth of the rendering area
    /// of the window) \param title    Title of the window \param style    %Window style, a bitwise
    /// OR combination of sf::Style enumerators
    ///
    ////////////////////////////////////////////////////////////
    ...
    ////////////////////////////////////////////////////////////
    virtual void create(
        VideoMode mode, const String &title, Uint32 style, const ContextSettings &settings);
