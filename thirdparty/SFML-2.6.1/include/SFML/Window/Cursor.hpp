...
public:
    ...
    enum Type
    {
        ...
        SizeTopLeft, //!< Top-left arrow cursor on Linux, same as SizeTopLeftBottomRight on other
                     //!< platforms
        SizeBottomRight, //!< Bottom-right arrow cursor on Linux, same as SizeTopLeftBottomRight on
                         //!< other platforms
        SizeBottomLeft,  //!< Bottom-left arrow cursor on Linux, same as SizeBottomLeftTopRight on
                         //!< other platforms
        SizeTopRight, //!< Top-right arrow cursor on Linux, same as SizeBottomLeftTopRight on other
                      //!< platforms
