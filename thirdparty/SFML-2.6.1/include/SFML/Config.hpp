...
// trigger a warning instead of an error, the compiler flag /sdl- (instead of /sdl) must be
// specified.
...
// With a bit of luck, the #pragma directive works, otherwise users get a warning (no error!) for
// unrecognized #pragma.
