...
struct SFML_GRAPHICS_API BlendMode
{
    ...
    ///
    /// \param sourceFactor      Specifies how to compute the source factor for the color and alpha
    /// channels. \param destinationFactor Specifies how to compute the destination factor for the
    /// color and alpha channels. \param blendEquation     Specifies how to combine the source and
    ...
    /// \brief Construct the blend mode given the factors and equation.
    ///
    /// \param colorSourceFactor      Specifies how to compute the source factor for the color
    /// channels. \param colorDestinationFactor Specifies how to compute the destination factor for
    /// the color channels. \param colorBlendEquation     Specifies how to combine the source and
    /// destination colors. \param alphaSourceFactor      Specifies how to compute the source
    /// factor. \param alphaDestinationFactor Specifies how to compute the destination factor.
