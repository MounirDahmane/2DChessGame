...
/// \li functors with no argument (this one is particularly useful for compatibility with
/// boost/std::%bind) \li functors with one argument of any type \li member functions from any class
/// with no argument
///
