...
/// sf::IpAddress a5("my_computer");                      // a local address created from a network
/// name sf::IpAddress a6("89.54.1.169");                      // a distant address sf::IpAddress
/// a7("www.google.com");                   // a distant address created from a network name
